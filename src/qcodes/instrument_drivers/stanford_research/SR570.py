...
class SR570(VisaInstrument):
    ...
    def __init__(self, name: str, address: str, **kwargs: Any):
        ...
        self.sensitivity_uncalibrated_mode: Parameter = self.add_parameter(
        ...
        self.sensitivity_uncalibrated_vernier: Parameter = self.add_parameter(
        ...
        self.input_offset_current_status: Parameter = self.add_parameter(
        ...
        self.input_offset_current_sign: Parameter = self.add_parameter(
        ...
        self.input_offset_uncalibrated_mode: Parameter = self.add_parameter(
        ...
        self.input_offset_uncalibrated_vernier: Parameter = self.add_parameter(
        ...
        self.bias_voltage_status: Parameter = self.add_parameter(
            "bias_voltage_status",
            get_cmd=None,
            set_cmd="BSON {}",
            val_mapping=on_off_val_mapping,
        ...
        self.bias_voltage: Parameter = self.add_parameter(
            "bias_voltage",
            get_cmd=None,
            set_cmd="BSLV {}",
        ...
        self.filter_type: Parameter = self.add_parameter(
            "filter_type",
            get_cmd=None,
            set_cmd="FLTT {}",
        ...
        self.filter_lowpass_frequency: Parameter = self.add_parameter(
        ...
        self.filter_highpass_frequency: Parameter = self.add_parameter(
        ...
        self.gain_mode: Parameter = self.add_parameter(
            "gain_mode",
            get_cmd=None,
            set_cmd="GNMD {}",
        ...
        self.blank: Parameter = self.add_parameter(
